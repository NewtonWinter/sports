      ...
      <body>
        <div class="container-fluid b a">
          ...
          <div style="text-align:right">
            <span><a  class="entre" href="entrar.php">Entre</a> ou <a  class="entre" href="cadastrar.php">Cadastre-se</a></span>
          </div>
        </div>
        ...
        <div>
          <form method="POST" action="cadastrandoUsuarioNoBanco.php">
            ...
            <br><br>			
            Cep: <input type="text" name="cep" required maxlength="9">
            <br><br>
            Rua: <input type="text" name="rua" required>
            <br><br>						
            Número da casa: <input type="text" name="numerocasa" required>
            <br><br>			
