	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>	
        ...
        <title>sports - tenis adidas</title>
        <meta charset="utf-8">
	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Tênis adidas Lite Racer 3.0</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/mulheres-calcados/tenis-adidas.jpg" alt="bola de basquete">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Tênis adidas Lite Racer 3.0</h5>
            <p class="card-text">Acerte na escolha do seu tênis, o adidas Lite Racer é o aliado diário para prática esportiva ou dia a dia casual.

 O cabedal (parte superior do calçado) em malha com tramas abertas, garante respirabilidade e suporte aos pés.

 Sua entressola e o solado em EVA  possuem cortes profundos para melhor flexibilidade,  pensadas para oferecer passadas mais suaves. </p>
            <a href="carrinho-de-compras.php?id=16" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
