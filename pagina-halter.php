	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Halter 5kg</h5>
            <p class="card-text">O Halter é produzido em ferro fundido altamente resistente.

O produto é resistente a oxidação e pode ser facilmente higienizável, 

O produto possui formato anatômico.

O acessório é ideal para treinos com o objetivo de condicionamento físico e fortalecimento muscular.</p>
            <a href="carrinho-de-compras.php?id=7" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
