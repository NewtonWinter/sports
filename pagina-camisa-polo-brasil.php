	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>	
        ...
        <title>sports - camisa polo brasil</title>
        <meta charset="utf-8">
	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Camisa Polo Liga Retrô Brasil</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/homens-roupas/camisa-polo-brasil.jpg" alt="bola de basquete">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Camisa Polo Liga Retrô Brasil</h5>
            <p class="card-text">Camisa Liga Retrô Brasil Polo Estrelas. Caracteristícas: Gola Polo V com recorte especial, estampa frontal silkada em verde, "9" silkado nas costas, visual Retrô, tecido 100% algodão de alta qualidade</p>
            <a href="carrinho-de-compras.php?id=13" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
