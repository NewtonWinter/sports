	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>	
        ...
        <title>sports - camisa polo psg</title>
        <meta charset="utf-8">
	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Camisa Polo PSG Sportswear</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/homens-roupas/camisa-polo-psg.jpg" alt="bola de basquete">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Camisa Polo PSG Sportswear</h5>
            <p class="card-text">Uma peça estilosa para usar nas diversas ocasiões é a Camisa Polo PSG Sportswear Piquet Crew Nike.

De mangas curtas, com gola polo e ajuste frontal por botões.

A camisa polo PSG possui aberturas laterais que fornecem um melhor caimento.

Confeccionada em algodão que oferece leveza e durabilidade.

Não perca a chance e adquira já a qualidade Nike!</p>
            <a href="carrinho-de-compras.php?id=14" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
