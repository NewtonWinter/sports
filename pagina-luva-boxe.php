	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>	
        ...
        <title>sports - luva de boxe</title>
        <meta charset="utf-8">
	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Luvas de Boxe Everlast</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/index/luva-boxe.jpg" alt="luva de boxe">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Luvas de Boxe Everlast</h5>
            <p class="card-text">A qualidade e padrão da Everlast, marca que está no mercado há mais de 100 anos e esteve sempre presente na história do boxe, traz o modelo Pro Style. Possui duas tecnologias: a EverFresh™ que evita odores e a EverCool™ que promove ventilação interna. Confeccionada em PU, tem 14 Oz e contém ajuste em velcro. Não perca a chance de ter não só um par de luvas mas, fazer parte de mais um capítulo do boxe. Torne seus movimentos no ringue inesquecíveis. Compre já!</p>
            <a href="carrinho-de-compras.php?id=1" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
