	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Maiô Puma</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/mulheres-roupas/maio-puma-feminino.jpg" alt="camisa do gremio">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Maiô Puma</h5>
            <p class="card-text">Com o Maiô Puma Nadador suas práticas aquáticas serão confortáveis com ótima elasticidade e também com bom caimento e ajuste junto ao corpo.

Confeccionado com tecido +SOLARMAX?, traz proteção contra os raios UV 50+ que bloqueia 97,5% dos raios solares, além de possuir a tecnologia XTRA LIFE® - permite alta resistência ao cloro, aumentando a durabilidade do produto.

É um tecido não tóxico com certificado OEKO-TEX®100.

Seu modelo não possui bojo, traz o logo Puma estampado no peito, conta com decote U e possui alças grossas na modelagem nadador.

Traz também um recorte nas costas que dá um charme a mais para a peça.

Aproveite!</p>
            <a href="carrinho-de-compras.php?id=18" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
