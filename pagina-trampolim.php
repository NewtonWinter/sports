	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Trampolim Polimet Semi Pro</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/index/trampolim.jpg" alt="trampolim">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Trampolim Polimet Semi Pro</h5>
            <p class="card-text">Uma forma divertida de se exercitar e queimar calorias, oferecendo muitos benefícios para quem quer ter uma vida saudável.

Os Trampolins foram desenvolvidos para fortalecer pernas e glúteos.

Utilizando diariamente, poderá reduzir a gordura corporal, melhorando o estado de saúde mental e físico.</p>
            <a href="carrinho-de-compras.php?id=8" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
