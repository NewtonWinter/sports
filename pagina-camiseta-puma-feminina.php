	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>	
        ...
        <title>sports - camiseta puma</title>
        <meta charset="utf-8">
	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Camiseta Puma Manga Curta Essentials Logo </strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/mulheres-roupas/camiseta-puma-feminina.jpg" alt="camisa do gremio">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Camiseta Puma Manga Curta Essentials Logo </h5>
            <p class="card-text">Confeccionada em algodão, a camiseta Essentials Logo tem ótimo caimento.

Possui mangas curtas, gola careca e com tira interna que protege do atrito junto à pele.

A estampa personalizada garante excelentes combinações para você sair sempre com muito estilo e ainda realizar as tarefas do dia a dia. Compre já a sua camiseta Puma!</p>
            <a href="carrinho-de-compras.php?id=17" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
