	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Relógio digital X Games</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/index/relogio.jpg" alt="relogio">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Relógio digital X Games</h5>
            <p class="card-text">Saiba sempre as horas e ainda complete seu look de forma extremamente estilosa com o relógio digital X Games Xmppd653.

O seu mecanismo é digital, pulseira em silicone com fecho simples e seu design vai te surpreender.

Ainda conta com timer, dual timer, resistente à água em 100 metros, alarme, cronógrafo e cronômetro e iluminação digital. Compre já seu relógio digital X Games!</p>
            <a href="carrinho-de-compras.php?id=5" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
