	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Tênis Fila KR5</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/homens-calcados/tenis-fila.jpg" alt="bola de basquete">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Tênis Fila KR5</h5>
            <p class="card-text">Leveza, frescor e amortecimento vão te acompanhar a cada km com a chegada do Fila KR5. Seu cabedal (parte superior do tênis) é em malha têxtil em tramas abertas com entressola otimizada pela tecnologia Energized para absorção dos impactos com efeito memória e resiliência. Já seu solado conta com o reforço das tecnologias Ever-Grip e Ever-Grip T em áreas estratégicas para excelente grip, aderência e durabilidade. </p>
            <a href="carrinho-de-compras.php?id=12" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
