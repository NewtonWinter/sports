	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Sandália Crocs Crocband</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/mulheres-calcados/sandalia.jpg" alt="bola de basquete">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Sandália Crocs Crocband</h5>
            <p class="card-text">Descolada e moderna, essa Sandália Crocs Adulto Crocband, é a opção perfeita em todos os momentos.

A palmilha é anatômina, fornecendo conforto sem igual, enquanto a tira em peça única oferece um ajuste prático e personalizado.

Já o solado em resina com ranhuras, o que garante estabilidade e maior aderência em todas as superfícies.

Outro diferencial do modelo, é a tecnologia Croslite, desenvolvida para proporcionar excelente absorção de impactos e amortecimento.</p>
            <a href="carrinho-de-compras.php?id=15" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
