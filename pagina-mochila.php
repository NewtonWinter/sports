	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Mochila Infantil Mizuno Energy</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/index/mochila.jpg" alt="mochila">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Mochila Infantil Mizuno Energy</h5>
            <p class="card-text">Prática e moderna, essa Mochila infantil Miznuno é a opção perfeita, em todos os momentos dos baixinhos. Com capacidade de 9 litros é ideal para levar todos seus itens para escola ou atividades casuais. A mochila possui alças reguláveis para melhor ajuste, conforto e praticidade, permitindo maior liberdade dos movimentos no transporte. Além disso, o logo da marca em destaque garante sua qualidade. Não perca a oportunidade e compre hoje sua mochila Mizuno!</p>
            <a href="carrinho-de-compras.php?id=6" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
