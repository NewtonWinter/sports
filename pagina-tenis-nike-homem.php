	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/homens-calcados/tenis-nike.jpg" alt="bola de basquete">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Tênis Nike Revolution</h5>
            <p class="card-text">Versátil e ultra confortável para a academia, treinos leves de corrida e uso diário. Quer um tênis Nike confortável com o melhor custo benefício? O Revolution 6 é para você dinâmico e moderno. Seu cabedal (parte superior do tênis) apresenta leveza, respirabilidade, mantém o frescor e flexibilidade dos movimentos. Na entressola, a inserção da espuma em toda a extensão garante uma pisada macia e suave com leve amortecimento. Já o solado do Nike Revolution 6 masculino oferece excelente tração e uma distribuição natural das passadas.</p>
            <a href="carrinho-de-compras.php?id=11" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
