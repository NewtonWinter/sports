	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Capacete para Bike Spin Unicórnio - Feminino</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/index/capacete.jpg" alt="capacete">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Capacete para Bike Spin Unicórnio - Feminino</h5>
            <p class="card-text">Indispensável para os passeios de bike da meninada, o Capacete Spin Feminino Infantil é a pedida certa. Em plástico e forro em isopor oferecem maior proteção contra os impactos. O fechamento por fivela de engate garante ajuste prático e personalizado. Esse Capacete Unicórnio conta com 6 aberturas para melhor ventilação e estampa personalizada para a diversão da criançada. Aproveite e compre o Capacete Spin Feminino Infantil hoje ainda!</p>
            <a href="carrinho-de-compras.php?id=2" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
