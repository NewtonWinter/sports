	...
	<div class="container-fluid b a">
      ...
      <!-- ************************************************************************************************* -->              
        ...
        <div class="conteiner-fluid" style="height: 70px; background-color: #BEBEBE; font-size: 30px; color: white; margin-bottom: 10px">
          <strong>Patins Oxer Darkness Gold</strong>
        </div>

        <div class="container zoom" style="height: 500px; width: 500px; border: 1px solid black; display: inline-block; margin-left: 10px">
          <img id="bolaFutsal" class="img-responsive" src="imagens/index/patins.jpg" alt="patins">
        </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Patins Oxer Darkness Gold</h5>
            <p class="card-text">Liberdade e diversão você encontra com esses Patins Oxer Darkness Gold!
...
Sua bota apresenta material têxtil acolchoado na parte interna para comodidade em todos os momentos com estrutura externa rígida que proporciona maior apoio e estabilidade durante os giros e saltos. As rodas em PU oferecem um deslize suave e confortável nas superfícies lisas e cimentadas. Com travas de segurança para reforçar o ajuste, os Patins Oxer apresentam base em alumínio e rolamentos ABEC7. De estilo Freestyle, sem freios, são indicados para você, que busca direcionamentos rápidos nas manobras com pequenos obstáculos. Não perca a oportunidade e garanta ótimos momentos de alegria e entretimento com os Patins Oxer Freestyle. Aproveite o preço!</p>
            <a href="carrinho-de-compras.php?id=9" class="btn btn-primary">COMPRAR</a>
          </div>
        </div>
